  ...
  return (
    <Overlay showShoppingCart={showShoppingCart}>
      ...
      >
        ...
        <div
          className={`flex h-full w-full flex-col items-center gap-5 px-5 max-lg:max-h-[555px] max-lg:p-5 sm:max-lg:max-h-[635px] lg:max-h-[calc(100%-484px)] lg:px-[95px] ${shoppingCartArrayActualLength > 0 ? "" : "gap-[50px] pb-[37px]"}`}
        >
          <ShoppingCartList
            shoppingCartArrayActualLength={shoppingCartArrayActualLength}
