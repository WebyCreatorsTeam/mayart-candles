...
const ColorOption = ({
  ...
  return (
    <div
      ...
      className={`group flex h-16 w-16 items-center justify-center rounded-full border-[#121515]  text-center sm:h-[70px] sm:w-[70px] xl:max-2xl:h-[60px] xl:max-2xl:w-[60px] ${currentCandleColor._id === color._id ? "border-2" : "border-[0.88px]"}`}
