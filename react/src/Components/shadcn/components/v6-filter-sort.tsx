...
export function V6FilterSort({
  ...
  sortType: string;
  setSortType: React.Dispatch<React.SetStateAction<TypeOfSortEnum>>;
  // filterSet: string;
  // setFilterSet: (value: TypeOfSortEnum) => void;
}) {
  return (
    <div className="absolute top-16 z-40 flex w-full space-x-4 p-4 *:flex-1 sm:top-44 xl:top-24">
      <Accordion type="single" collapsible>
        <AccordionItem value="filter">
          ...
          <AccordionContent className="rounded-md bg-white p-4 shadow-md">
