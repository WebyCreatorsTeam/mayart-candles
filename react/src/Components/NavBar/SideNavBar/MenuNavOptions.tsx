...
const MenuNavOptions = ({
  ...
  return (
    ...
    >
      <button
        className="z-40 flex w-full text-center items-center justify-center gap-4 bg-white px-7 py-5  active:bg-primary-pink lg:justify-evenly lg:gap-1 lg:px-3 lg:text-[32px] lg:font-normal lg:hover:bg-primary-pink"
