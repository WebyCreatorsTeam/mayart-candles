...
interface IAddNewColor {
    handleAddColor: (ev: SyntheticEvent) => any
...
const AddNewColor: FC<IAddNewColor> = ({ handleAddColor, handeValidColorsName, handleValidColorCode, loader, handleAddColorToArrColor, setOpenPopup }) => {
    return (
