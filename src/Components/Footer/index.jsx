...
const index = () => {
  return (
    <div className='max-w-[1240px] mx-auto py-20 px-4 grid lg:grid-cols-2 text-300' id='footer'>
      <div className='container'>
      <img src={ellipse} alt="ellipse15" id='image2'/>
      <div className='p'>

              <h3 className='connect'>!בואו נשמור על קשר</h3><br />
      ...
      <p className='weby'>created by weby</p><br /> 
        </div>
